---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
-----                             Part 11: PROVIDER for the study sample                                -----  
--------------------------------------------------------------------------------------------------------------- 
---------------------------------------------------------------------------------------------------------------
/* Tables for this eaxtraction: 
1. PROVIDER table from PCORNET.
2. External to PCORNET table (NEXT_OriginalNPIFROMBaseTaxonomy) with NPI values on encounters of interest. 
...
case when b.[Healthcare Provider Taxonomy Code_1] is not NULL and b.[Healthcare Provider Taxonomy Code_1] in ('102X00000X','171R00000X','172A00000X','247ZC0005X','367A00000X','374K00000X','374T00000X','376G00000X','390200000X') then '0'
		...
		when b.[Healthcare Provider Taxonomy Code_1] is not NULL and b.[Healthcare Provider Taxonomy Code_1] in ('363L00000X','363LA2100X','363LA2200X','363LC0200X','363LC1500X','363LF0000X','363LG0600X','363LN0000X','363LN0005X','363LP0200X','363LP0222X',
		...
		when b.[Healthcare Provider Taxonomy Code_1] is not NULL and b.[Healthcare Provider Taxonomy Code_1] in ('101Y00000X','101YA0400X','101YM0800X','101YP1600X','101YP2500X','101YS0200X','102L00000X','103G00000X','103GC0700X','103K00000X','103T00000X','103TA0400X','103TA0700X',
...
into #NextD_PROVIDER
from [dbo].[PROVIDER]  a
left join/* assuming ENCOUNTER table contains NPI values in place of PROVIDERID */ [dbo].[NEXT_OriginalNPIFROMBaseTaxonomy] b on a.PROVIDER_NPI=b.NPI ;
---------------------------------------------------------------------------------------------------------------
